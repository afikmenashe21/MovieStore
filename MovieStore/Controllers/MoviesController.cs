...
namespace MovieStore.Controllers
{
    ...
    public class MoviesController : Controller
    {
        ...
        */
        /*
         string movieName , string releaseDate , string movieDirector , int movieRating
         */
        public void Tweet(string movieName, string releaseDate, string movieDirector, int movieRating)
        {
            string twitterURL = "https://api.twitter.com/1.1/statuses/update.json";

            string oauth_consumer_key = "0Uv01QshcLim4irHA9OcRU7vD";
            string oauth_consumer_secret = "Ob2SlXFo3KiMfptKMAOqDNz6lVKpjifq08RYViJWQW0TKGpfAw";
            string oauth_token = "1325414546182430721-2PEKxM3xbmAwmQ8XCJ85wd3QijyrU6";
            string oauth_token_secret = "lY0FbrSAa1eEDIFAmORjD04kOfkK8lrcP9VZZJxSik3DF";
